...
class Module:
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            ...
            'Name': 'Invoke-Infector',

            # list of one or more authors for the module
            'Author': ['@theri'],

            # more verbose multi-line description of the module
            'Description': ('THIS IS A DESCRIPTION LINE 1'
                            'description line 2'),
        ...
        self.options = {
            ...
            'Agent' : {
                ...
                'Description'   :   'Agent of which to be infected',
                'Required'      :   True,
                'Value'         :   ''
            },
	    'InfectionPath' : {
    ...
    def generate(self):
        ...
        moduleSource = self.mainMenu.installPath + "data/module_source/lateral_movement/Invoke-Infector.ps1"
        try:
        ...
        f = open(self.options['Macro']['Value'], 'r')
        macro = f.read()
        f.close()
        script = """
[CmdletBinding()] Param(
